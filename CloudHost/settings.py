"""
Django settings for CloudHost project.
...
SECRET_KEY = 'django-insecure-+kpx-87!9q-k1+--+5pu8vc-*z^=$=1nynt=h$ds!*o40hn6+y'
...
WSGI_APPLICATION = 'CloudHost.wsgi.application'
